...
echo curl -H 'Content-Type: application/x-ndjson' -XPOST 'localhost:9400/shakespeare/doc/_bulk?pretty' --data-binary @${OUTPUT}
curl -H 'Content-Type: application/x-ndjson' -XPOST 'localhost:9400/shakespeare/doc/_bulk?pretty' --data-binary @${OUTPUT}
